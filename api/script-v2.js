          ...
          text:
            ...
            (lang === "en"
              ? [
                  ...
                  'Required JSON shape: { "message": "concrete scene proposal", "questions": [], "patch": {} }',
                  ...
                  "message must describe visible action, event, conflict, character choice, reveal, or story development.",
                  "Do not describe what the scene should achieve. Describe what exactly happens in the scene.",
                  "Generic Commentary is forbidden unless converted into concrete action.",
                  "Forbidden generic phrasing includes: strengthen the emotion, show hope, make it deeper, emphasize the atmosphere, add tension.",
                  "message must start with a concrete action or concrete plot development, not with commentary about the scene.",
                  ...
                  "Patch values for narrative.scene_setup and narrative.scene_development must contain event, action, conflict, reveal, choice, or state change, not abstract intent.",
                  ...
                  "If a question is asked, first return a concrete version of the scene in message, then ask the single question.",
              ...
              : [
                  ...
                  'Обязательная JSON-форма: { "message": "конкретное сценарное предложение", "questions": [], "patch": {} }',
                  ...
                  "message должен описывать видимое действие, событие, конфликт, выбор персонажа, раскрытие или развитие истории.",
                  "Не описывай, чего сцена должна добиться. Опиши, что именно происходит в сцене.",
                  "Generic Commentary запрещён, если он не преобразован в конкретное действие.",
                  "Запрещённые generic-формулировки: усилить эмоцию, показать надежду, сделать глубже, подчеркнуть атмосферу, добавить напряжение.",
                  "message должен начинаться с конкретного действия или конкретного сюжетного развития, а не с комментария о сцене.",
                  ...
                  "Patch values для narrative.scene_setup и narrative.scene_development должны содержать событие, действие, конфликт, открытие, выбор или изменение состояния, а не абстрактное намерение.",
                  ...
                  "Если вопрос задаётся, сначала верни конкретную версию сцены в message, затем задай единственный вопрос.",
